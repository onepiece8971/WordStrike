<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/semantic.css">
    ...
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/semantic.js"></script>
